...
class database_connection(object):
    def __init__(self):
        ...
        self.setup_query = "INSERT OR IGNORE INTO province_setup(ProvID, Culture, Religion, TradeGoods, Citizens, Freedmen, Slaves, Tribesmen, Nobles, Civilization, SettlementRank, Barbarian, NameRef, AraRef, Terrain, isChanged) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
        ...
        while i < total_provinces:
            try:
                for province in land_provinces + self.new_land_provinces:
                    ...
                    query = "INSERT OR IGNORE INTO province_setup(ProvID, Culture, Religion, TradeGoods, Citizens, Freedmen, Slaves, Tribesmen, Nobles, Civilization, SettlementRank, Barbarian, NameRef, AraRef, Terrain, isChanged) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
